...
首先我给大家看一张图，如果大家对这张图有些地方不太理解的话，我希望你们看完我这篇文章会恍然大悟。总体架构：

![总体架构](assets/16ebc20c173ddc33tplv-t2oaga2asx-watermark.awebp)
...
>
> ### 谈谈对 Dubbo 和 Spring Cloud 的认识(两者关系)
>
...
![img](assets/16ebc217754bbd75tplv-t2oaga2asx-watermark.awebp)

那怎么办呢？我们当然不会那么傻乎乎的，第一时间就是去找 **中介** 呀，它为我们提供了统一房源的地方，我们消费者只需要跑到它那里去找就行了。而对于房东来说，他们也只需要把房源在中介那里发布就行了。

![img](assets/16ebc21a63a8c04ftplv-t2oaga2asx-watermark.awebp)

那么现在，我们的模式就是这样的了。

![img](assets/16ebc21d88611f8atplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc22031ad3eaatplv-t2oaga2asx-watermark.awebp)
...
![Eureka架构图](assets/16e86737ea057126tplv-t2oaga2asx-watermark.awebp)Eureka架构图

当然，可以充当服务发现的组件有很多：`Zookeeper` ，`Consul` ， `Eureka` 等。

更多关于 `Eureka` 的知识(自我保护，初始注册策略等等)可以自己去官网查看，或者查看我的另一篇文章 [深入理解 Eureka](https://juejin.cn/post/6844904001444511758)。
...
![img](assets/16ebc22c6c20487dtplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc22fdf3c8470tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc233e2b80367tplv-t2oaga2asx-watermark.awebp)

我们可以看到 `Nginx` 是接收了所有的请求进行负载均衡的，而对于 `Ribbon` 来说它是在消费者端进行的负载均衡。如下图。

![img](assets/16ebc2364acb65aatplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc24783b5e7fctplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc24d04aaf4d6tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc24ed9701419tplv-t2oaga2asx-watermark.awebp)

这就叫 **服务雪崩**。妈耶，上面两个 **熔断** 和 **降级** 你都没给我解释清楚，你现在又给我扯什么 **服务雪崩** ？😵😵😵

别急，听我慢慢道来。

![img](assets/16ebc251eba559c9tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc256025dae7btplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc258218b66adtplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc25a33523ae5tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc25e0f16f172tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc26128b67534tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc2651947af87tplv-t2oaga2asx-watermark.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/11/30/16ebc2678affa4af~tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc26958ea0fe7tplv-t2oaga2asx-watermark.awebp)
...
![img](assets/16ebc26b21515692tplv-t2oaga2asx-watermark.awebp)
...
作者：FrancisQ
链接：https://juejin.cn/post/6844904007975043079
来源：掘金
